...
const featured = [
  ...
  },
  {
    ...
    price: '$15/entry',
    image: 'https://images.unsplash.com/photo-1556909212-d5b6043e67f3?auto=format&fit=crop&w=1600&q=80',
    rating: 4.7,
    reviews: 198,
    distance: '3.1 km',
    isBookmarked: false
...
export default function App() {
  ...
  useEffect(() => {
    ...
    try { localStorage.setItem('ras-theme', theme) } catch {}
  }, [dark])
    ...
    <Layout>
      <header style={{
        ...
        <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
          ...
          <MenuTriggerComponent>
            <Button variant="ghost" size="sm" style={{ padding: '4px', borderRadius: '50%' }}>
              <Avatar 
          ...
          <SidebarContent>
            ...
            <SidebarGroup label="Display">
              <SidebarItem
                ...
                label="Dark mode"
                badge={
                  <Switch size="sm" isSelected={dark} onChange={setDark} aria-label="Toggle dark mode" />
                }
              />
            </SidebarGroup>
          </SidebarContent>
        ...
        <LayoutContent maxWidth="4xl">
          ...
          <section style={{ marginBottom: '4rem' }}>
            <div style={{ 
              ...
              <div style={{
                ...
                width: '40%',
                height: '100%',
                background: 'linear-gradient(135deg, var(--color-brand-primary)10, transparent 60%)',
                pointerEvents: 'none'
              }} />
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <h1 style={{ 
                  ...
                  fontWeight: 800,
                  lineHeight: 1.1,
                  background: 'linear-gradient(135deg, var(--color-semantic-text-primary) 0%, var(--color-brand-primary) 100%)',
                  backgroundClip: 'text',
                  WebkitBackgroundClip: 'text',
                  color: 'transparent'
                }}>
                  Discover Amazing<br />Sports Facilities
                </h1>
                ...
                <p style={{ 
                  ...
                  Find and book the perfect sports facility near you. From tennis courts to fitness centers, discover your next activity.
                </p>
                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    <div style={{ color: 'var(--color-semantic-text-secondary)' }}>Clubs</div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <div style={{ 
                      fontSize: '2rem', 
                    ...
                    <div style={{ color: 'var(--color-semantic-text-secondary)' }}>Members</div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <div style={{ 
                      fontSize: '2rem', 
                    ...
                    <div style={{ color: 'var(--color-semantic-text-secondary)' }}>Satisfaction</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section style={{ marginBottom: '4rem' }}>
            ...
            <Tabs selectedKey={activeTab} onSelectionChange={(key) => setActiveTab(key as string)}>
              <TabList aria-label="Club categories" style={{ marginBottom: '2rem' }}>
          ...
          <footer style={{ 
            ...
            © {new Date().getFullYear()} ras‑UI Club Explorer • Built with accessibility and design tokens
          </footer>
        </LayoutContent>
      </main>
    </Layout>
...
function FeatureCard({ icon, title, desc }: { icon: string; title: string; desc: string }) {
  return (
    ...
    onMouseEnter={(e) => {
      ...
      e.currentTarget.style.boxShadow = '0 12px 32px var(--color-semantic-shadow-md)'
    }}
    onMouseLeave={(e) => {
      e.currentTarget.style.transform = 'translateY(0)'
      e.currentTarget.style.boxShadow = '0 4px 16px var(--color-semantic-shadow-sm)'
    }}>
      <div style={{ marginBottom: '1.5rem', display: 'flex', justifyContent: 'center' }}>
        <div style={{
          ...
          height: '4rem',
          borderRadius: '1rem',
          background: 'linear-gradient(135deg, var(--color-brand-primary), var(--color-brand-primary)90)',
          display: 'flex',
          alignItems: 'center',
...
function TestimonialCard({ name, role, content, avatar, rating }: { 
  ...
  return (
    ...
    onMouseEnter={(e) => {
      ...
      e.currentTarget.style.boxShadow = '0 8px 24px var(--color-semantic-shadow-md)'
    }}
    onMouseLeave={(e) => {
      e.currentTarget.style.transform = 'translateY(0)'
      e.currentTarget.style.boxShadow = '0 4px 16px var(--color-semantic-shadow-sm)'
      ...
      <div style={{ marginBottom: '1.5rem', display: 'flex', gap: '0.25rem' }}>
        {Array.from({ length: 5 }, (_, i) => (
          <span 
            key={i} 
            style={{ 
              color: i < rating ? '#fbbf24' : 'var(--color-semantic-text-disabled)',
              fontSize: '1.25rem'
            }}
          >
            ★
