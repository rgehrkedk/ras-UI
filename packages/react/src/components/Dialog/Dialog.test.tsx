...
describe("Dialog", () => {
  ...
  it("renders with description", () => {
    render(
      <DialogTrigger isOpen={true}>
        <Dialog title="Test Dialog" description="This is a test dialog">
          <p>Content</p>
        </Dialog>
      </DialogTrigger>,
    );
  ...
  it("traps focus within dialog", async () => {
    ...
    render(
      <DialogTrigger isOpen={true}>
        <Dialog title="Focus Test" footer={<Button>Footer Button</Button>}>
...
describe("AlertDialog", () => {
  ...
  it("renders custom icon", () => {
    ...
    render(
      <DialogTrigger isOpen={true}>
        <AlertDialog title="Custom Icon" icon={<CustomIcon />} />
      </DialogTrigger>,
    );
  ...
  it("renders additional content", () => {
    render(
      <DialogTrigger isOpen={true}>
        <AlertDialog title="Alert with Content" description="Main description">
...
describe("DialogTrigger", () => {
  ...
  it("calls onOpenChange when state changes", async () => {
    ...
    render(
      <DialogTrigger isOpen={true} onOpenChange={handleOpenChange}>
