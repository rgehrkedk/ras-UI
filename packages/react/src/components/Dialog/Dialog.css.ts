...
export const dialogOverlay = style({
  ...
  '@media': {
    '(prefers-reduced-motion: no-preference)': {
      animation: `${fadeIn} ${theme.animation.duration.fast} ${theme.animation.easing.easeOut}`,
    },
  },
});
...
export const dialogContainer = style({
  ...
  '@media': {
    '(prefers-reduced-motion: no-preference)': {
      animation: `${slideIn} ${theme.animation.duration.fast} ${theme.animation.easing.easeOut}`,
    },
  },
