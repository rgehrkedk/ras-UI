...
describe("Layout", () => {
  ...
  it("preserves additional props", () => {
    render(<Layout data-testid="layout-test">Test</Layout>);
...
describe("LayoutHeader", () => {
  ...
  it("preserves additional props", () => {
    render(<LayoutHeader data-testid="header-test">Test</LayoutHeader>);
...
describe("LayoutBody", () => {
  ...
  it("preserves additional props", () => {
    render(<LayoutBody data-testid="body-test">Test</LayoutBody>);
...
describe("LayoutMain", () => {
  ...
  it("preserves additional props", () => {
    render(<LayoutMain data-testid="main-test">Test</LayoutMain>);
...
describe("LayoutContent", () => {
  ...
  it("preserves additional props", () => {
    render(<LayoutContent data-testid="content-test">Test</LayoutContent>);
  ...
  it("constrains content width based on maxWidth prop", () => {
    ...
    rerender(<LayoutContent maxWidth="full">Full width content</LayoutContent>);
...
describe("LayoutFooter", () => {
  ...
  it("preserves additional props", () => {
    render(<LayoutFooter data-testid="footer-test">Test</LayoutFooter>);
    ...
    render(
      <Layout>
        ...
        <LayoutBody>
          ...
          <LayoutMain>
            <LayoutContent maxWidth="xl">Responsive Content</LayoutContent>
          </LayoutMain>
        </LayoutBody>
      </Layout>,
    );
