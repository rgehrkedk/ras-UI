  ...
  variants: {
    destructive: {
      true: {
        ...
        ':hover': {
          backgroundColor: 'var(--color-components-menu-item-background-destructive-hover)',
        ...
        selectors: {
          ...
          '&[data-pressed="true"]': {
            backgroundColor: 'var(--color-components-menu-item-background-destructive-active)',
