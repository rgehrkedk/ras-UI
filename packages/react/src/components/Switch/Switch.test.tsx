...
describe('Switch', () => {
  ...
  it('renders with description', () => {
    ...
    expect(screen.getByText('This enables push notifications')).toBeInTheDocument();
  });

  it('renders with helper text', () => {
    render(
      <Switch helperText="Helper text for this setting">
        Setting
      </Switch>
    );
    
    expect(screen.getByText('Helper text for this setting')).toBeInTheDocument();
  });
  ...
  it('does not toggle when disabled', async () => {
    ...
    render(<Switch isDisabled onChange={handleChange}>Disabled</Switch>);
