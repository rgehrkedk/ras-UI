...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A loading spinner component with consistent styling and accessibility support.",
      },
    },
  },
  tags: ["autodocs"],
...
export const CustomColor: Story = {
  render: () => (
    ...
    >
      ...
      >
        ...
        <span
          style={{ fontSize: "12px", color: "var(--color-semantic-primary)" }}
        >
          Primary
        </span>
      </div>
      ...
      >
        ...
        <span
          style={{ fontSize: "12px", color: "var(--color-semantic-danger)" }}
        >
          Danger
        </span>
      </div>
      ...
      >
        ...
        <span
          style={{ fontSize: "12px", color: "var(--color-semantic-success)" }}
        >
          Success
        </span>
      </div>
      ...
      >
        ...
        <span
          style={{ fontSize: "12px", color: "var(--color-semantic-warning)" }}
        >
          Warning
        </span>
      </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          "The spinner inherits the color from its parent element via currentColor.",
      },
    },
  },
};
