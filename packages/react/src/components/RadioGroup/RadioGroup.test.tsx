...
describe('RadioGroup', () => {
  ...
  it('supports controlled state', async () => {
    ...
    const { rerender } = render(
      <RadioGroup aria-label="Controlled" value="option1" onChange={handleChange}>
        <RadioOption value="option1">Option 1</RadioOption>
        <RadioOption value="option2">Option 2</RadioOption>
      </RadioGroup>
    );
    ...
    rerender(
      <RadioGroup aria-label="Controlled" value="option2" onChange={handleChange}>
        <RadioOption value="option1">Option 1</RadioOption>
        <RadioOption value="option2">Option 2</RadioOption>
      </RadioGroup>
    );
  ...
  it('handles disabled state', async () => {
    ...
    render(
      <RadioGroup aria-label="Disabled group" isDisabled onChange={handleChange}>
        <RadioOption value="option1">Option 1</RadioOption>
        <RadioOption value="option2">Option 2</RadioOption>
      </RadioGroup>
    );
    ...
    it('renders different sizes for individual options', () => {
      render(
        <RadioGroup aria-label="Mixed sizes">
          <RadioOption value="sm" size="sm">Small</RadioOption>
          <RadioOption value="md" size="md">Medium</RadioOption>
          <RadioOption value="lg" size="lg">Large</RadioOption>
        </RadioGroup>
      );
    ...
    it('forwards ref correctly for RadioOption', () => {
      ...
      render(
        <RadioGroup aria-label="Ref test">
          <RadioOption ref={ref} value="option1">With ref</RadioOption>
        </RadioGroup>
      );
    ...
    it('can be individually disabled', async () => {
      ...
      render(
        <RadioGroup aria-label="Individual disable" onChange={handleChange}>
          ...
          <RadioOption value="disabled" isDisabled>Disabled</RadioOption>
        </RadioGroup>
      );
  ...
  describe('Accessibility', () => {
    ...
    it('works with aria-label when no visible label', () => {
      ...
      const radioGroup = screen.getByRole('radiogroup', { name: 'Hidden label group' });
      expect(radioGroup).toBeInTheDocument();
    });
