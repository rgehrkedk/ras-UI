...
describe('ListBox', () => {
  ...
  describe('Selection Behavior', () => {
    ...
    it('should support multiple selection', async () => {
      ...
      await waitFor(() => {
        expect(onSelectionChange).toHaveBeenLastCalledWith(new Set(['item1', 'item2']));
      });
    });
  ...
  describe('Keyboard Navigation', () => {
    it('should support arrow key navigation', async () => {
      ...
      render(
        <ListBox aria-label="Keyboard navigation listbox" selectionMode="single">
          <ListBoxItem id="item1">First Item</ListBoxItem>
          <ListBoxItem id="item2">Second Item</ListBoxItem>
          <ListBoxItem id="item3">Third Item</ListBoxItem>
        </ListBox>
      ...
      expect(screen.getByText('First Item').closest('[role="option"]')).toHaveFocus();

      await user.keyboard('{ArrowDown}');
      expect(screen.getByText('Second Item').closest('[role="option"]')).toHaveFocus();
    ...
    it('should support Home and End keys', async () => {
      ...
      render(
        <ListBox aria-label="Home/End navigation listbox" selectionMode="single">
          <ListBoxItem id="item1">First Item</ListBoxItem>
          <ListBoxItem id="item2">Second Item</ListBoxItem>
          <ListBoxItem id="item3">Third Item</ListBoxItem>
        </ListBox>
      ...
      expect(screen.getByText('Third Item').closest('[role="option"]')).toHaveFocus();
  ...
  describe('Disabled State', () => {
    ...
    it('should disable individual items', async () => {
      ...
      render(
        ...
        >
          <ListBoxItem id="item1">First Item</ListBoxItem>
          <ListBoxItem id="item2" isDisabled>Disabled Item</ListBoxItem>
          <ListBoxItem id="item3">Third Item</ListBoxItem>
        </ListBox>
      );
