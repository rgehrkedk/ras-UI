...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Accessible ListBox component built on React Aria Components with single/multiple selection modes.",
      },
    },
  },
  argTypes: {
    ...
    const sections = [
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: "doc2",
            label: "Meeting Minutes.docx",
            description: "Yesterday",
          },
          {
            id: "doc3",
            label: "Budget Report.xlsx",
      ...
      <div style={{ display: "flex", gap: "2rem", flexWrap: "wrap" }}>
        <div>
          ...
          <div style={{ width: "250px" }}>
            <ListBox aria-label="Normal state example" selectionMode="single">
...
export const BrandShowcase: Story = {
  ...
  render: () => {
    const ComponentVariants = () => {
      ...
      const [multiSelected, setMultiSelected] = useState<Selection>(
        new Set(["project1", "project3"]),
      );
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "ListBox appearance across all three brand themes, showing how list selection components adapt their visual styling while maintaining selection states and keyboard navigation.",
      },
    },
  },
};
