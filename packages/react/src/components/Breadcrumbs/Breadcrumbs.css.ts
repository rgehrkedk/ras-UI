...
export const breadcrumbEllipsisButtonBase = style({
  ...
  ":hover": {
    ...
    backgroundColor:
      theme.color.components.breadcrumbs.ellipsis.backgroundHover,
  },
...
globalStyle(
  `${breadcrumbEllipsisMenuBase} [role="menuitem"][data-disabled="true"]`,
  {
    opacity: 0.5,
    cursor: "not-allowed",
  },
...
globalStyle(
  `${breadcrumbEllipsisMenuBase} [role="menuitem"][data-disabled="true"]:hover`,
  {
    backgroundColor: "transparent",
    color: theme.color.text.primary,
  },
