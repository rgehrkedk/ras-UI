...
const meta: Meta<typeof Breadcrumbs> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Accessible breadcrumb navigation component built on React Aria Components with auto-collapse functionality.",
      },
    },
  },
  argTypes: {
...
export const AutoCollapse: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "When there are more items than maxItems, the breadcrumb automatically collapses middle items into an ellipsis menu. Click the ellipsis to see collapsed items.",
      },
    },
  },
};
...
export const BrandShowcase: Story = {
    ...
    const ComponentVariants = () => (
      <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
        <div>
          ...
          <Breadcrumbs items={basicItems} size="md" separator="chevron-right" />
        </div>
        <div>
          <h5
            style={{
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Breadcrumbs appearance across all three brand themes, showing how navigation elements adapt their visual styling while maintaining consistent functionality and accessibility features.",
      },
    },
  },
};
