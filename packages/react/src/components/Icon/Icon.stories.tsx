...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Icon component with consistent sizing and positioning using the design system icon library. Built on top of IconWrapper for standardized styling.",
      },
    },
  },
  tags: ["autodocs"],
...
export const NamedIcons: Story = {
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      <div>
        <h3
          style={{ margin: "0 0 1rem 0", fontSize: "14px", fontWeight: "bold" }}
        >
          Common Named Icon Components
        </h3>
        <div
          style={{
            display: "flex",
