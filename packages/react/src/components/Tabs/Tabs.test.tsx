  ...
  it('handles shouldForceMount prop correctly', () => {
    render(
      <Tabs defaultSelectedKey="first">
        ...
        <TabPanel id="first">First content</TabPanel>
        <TabPanel id="second" shouldForceMount>Second content (always mounted)</TabPanel>
      </Tabs>
    );

    // Both panels should be in DOM due to shouldForceMount on second
    expect(screen.getByText('First content')).toBeInTheDocument();
    expect(screen.getByText('Second content (always mounted)')).toBeInTheDocument();
  });
    ...
    render(
      <Tabs ref={tabsRef}>
        <TabList aria-label="Ref test" ref={tabListRef}>
          <Tab id="first" ref={tabRef}>First</Tab>
        </TabList>
        <TabPanel id="first" ref={tabPanelRef}>First content</TabPanel>
      </Tabs>
    );
