  ...
  variants: {
    variant: {
      primary: {
        ...
        ":hover": {
          backgroundColor:
            theme.color.components.button.primary.backgroundHover,
        ...
        ":active": {
          backgroundColor:
            theme.color.components.button.primary.backgroundActive,
      ...
      secondary: {
        ...
        ":hover": {
          backgroundColor:
            theme.color.components.button.secondary.backgroundHover,
          transform: "translateY(-1px)",
          boxShadow: theme.elevation.sm,
        },
        ...
        ":active": {
          backgroundColor:
            theme.color.components.button.secondary.backgroundActive,
          transform: "translateY(0)",
        },
      },
      ...
      danger: {
        ...
        ":active": {
          backgroundColor:
            theme.color.components.button.danger.backgroundActive,
          transform: "translateY(0)",
        },
      },
