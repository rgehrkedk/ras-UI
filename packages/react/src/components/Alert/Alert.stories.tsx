...
export const Variants: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Alerts support different variants to communicate message urgency and type.",
      },
    },
  },
};
...
export const WithTitles: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Alerts can include titles to provide clear context for the message.",
      },
    },
  },
};
...
export const Sizes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Alerts support three sizes to match different interface contexts and importance levels.",
      },
    },
  },
};
...
export const Dismissible: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      <Alert variant="success" dismissible>
        Your profile has been updated successfully. You can dismiss this
        message.
      </Alert>
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Dismissible alerts allow users to close messages when they are no longer needed.",
      },
    },
  },
};
...
export const CustomIcons: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Alerts can use custom icons or hide icons completely for different visual treatments.",
      },
    },
  },
};
...
export const WithActions: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Alerts can include action buttons to provide immediate next steps for users.",
      },
    },
  },
};
...
export const NotificationPanel: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Example of alerts used in a notification panel or feed interface.",
      },
    },
  },
};
...
export const AccessibilityDemo: Story = {
  render: () => (
    ...
    >
      <p style={{ fontSize: "0.875rem", color: "var(--color-text-secondary)" }}>
        Try using keyboard navigation (Tab, Enter, Escape) to interact with
        these alerts:
      </p>
      ...
      <Alert
        ...
        role="alert"
      >
        This alert can be dismissed using the Escape key or clicking the close
        button.
      </Alert>
      ...
      >
        Screen readers will announce this alert content and provide access to
        actions.
      </Alert>

      <Alert variant="warning" title="Focus Management">
        Dismiss button receives proper focus and can be activated with Enter or
        Space.
      </Alert>

      <p style={{ fontSize: "0.875rem", color: "var(--color-text-secondary)" }}>
        Each alert includes proper ARIA attributes and supports keyboard
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Alerts are fully accessible with keyboard navigation, screen reader support, and proper ARIA roles.",
      },
    },
  },
};
