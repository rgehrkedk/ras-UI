...
const meta: Meta<typeof KeyboardShortcut> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Lightweight, platform‑aware shortcut label and optional handler. Renders a compact “kbd” chip and (optionally) binds a key combo to an action.\n\n" +
  ...
  argTypes: {
    ...
    ignoreWhenTyping: {
      ...
      description:
        "Prevent triggering while typing in inputs/textarea/contentEditable",
    },
    onTrigger: {
      action: "trigger",
...
export const Basic: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Inline visual chip only. Use to hint available shortcuts near related UI.",
      },
    },
  },
};
...
export const WithTrigger: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Functional binding example. Shortcut increments the counter when pressed. Defaults to ignoring keypresses while typing.",
      },
    },
  },
};
...
export const ActionControl: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use Controls to tweak props. Press the configured combo to see an entry in the Actions panel under the "trigger" event.',
      },
    },
  },
};
...
export const PlainKeyTrigger: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Plain key example (no modifier). Any single letter/number, named key (Enter, Escape), function keys (F1–F12), and space are supported.",
      },
    },
  },
};
