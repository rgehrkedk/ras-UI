...
describe("NumberField", () => {
  ...
  it("renders helper text", () => {
    render(<NumberField label="Age" helperText="Must be between 18 and 100" />);
  ...
  it("handles disabled state", async () => {
    ...
    render(<NumberField label="Disabled" isDisabled onChange={handleChange} />);
  ...
  it("supports controlled input", async () => {
    ...
    const { rerender } = render(
      <NumberField label="Controlled" value={10} onChange={handleChange} />,
    );
    ...
    rerender(
      <NumberField label="Controlled" value={25} onChange={handleChange} />,
    );
  ...
  describe("Stepper Buttons", () => {
    ...
    it("increments value when increment button is clicked", async () => {
      ...
      render(
        <NumberField label="Stepper Test" value={5} onChange={handleChange} />,
      );
    ...
    it("disables stepper buttons when field is disabled", () => {
      render(<NumberField label="Disabled Steppers" isDisabled value={5} />);
  ...
  describe("Keyboard Input", () => {
    it("handles arrow key increments and decrements", async () => {
      ...
      render(
        <NumberField label="Arrow Keys" value={10} onChange={handleChange} />,
      );
  ...
  describe("Accessibility", () => {
    ...
    it("works without visible label when aria-label is provided", () => {
      render(
        <NumberField aria-label="Quantity" placeholder="Enter quantity..." />,
      );
  ...
  describe("Edge Cases", () => {
    ...
    it("handles invalid number input gracefully", async () => {
      ...
      render(<NumberField label="Test" onChange={handleChange} />);
