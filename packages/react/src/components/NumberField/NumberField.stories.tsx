...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Accessible number field component built on React Aria Components with stepper buttons, validation support, and number formatting.',
      },
    },
  },
  argTypes: {
...
export const BrandShowcase: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'NumberField appearance across all three brand themes, demonstrating how numerical input components adapt their visual styling while maintaining stepper functionality and number formatting capabilities.',
      },
    },
  },
};
