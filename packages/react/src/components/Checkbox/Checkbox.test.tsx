...
describe("Checkbox", () => {
  ...
  it("supports indeterminate state", () => {
    render(<Checkbox isIndeterminate>Partially selected</Checkbox>);
  ...
  it("shows checkmark when selected", () => {
    render(<Checkbox isSelected>Selected checkbox</Checkbox>);
  ...
  it("supports keyboard navigation", async () => {
    ...
    render(<Checkbox onChange={handleChange}>Keyboard accessible</Checkbox>);
  ...
  it("supports required validation", () => {
    render(<Checkbox isRequired>Required checkbox</Checkbox>);
  ...
  describe("Edge Cases", () => {
    it("handles rapid clicks without issues", async () => {
      ...
      render(<Checkbox onChange={handleChange}>Rapid click test</Checkbox>);
    ...
    it("handles defaultSelected prop", () => {
      render(<Checkbox defaultSelected>Default selected</Checkbox>);
