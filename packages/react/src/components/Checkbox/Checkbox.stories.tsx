...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Accessible checkbox component built on React Aria Components with support for checked, unchecked, and indeterminate states.',
      },
    },
  },
  argTypes: {
...
export const CheckboxGroup: Story = {
  render: () => {
    ...
    const handleChange = (key: keyof typeof selections) => (isSelected: boolean) => {
...
export const ValidationStates: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '400px' }}>
      ...
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <Checkbox 
            description="We'll only send you important updates and never spam"
          >
            Email notifications
          </Checkbox>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Examples of checkbox validation states including error messages, descriptions, and complex form validation scenarios. All examples include proper ARIA attributes for screen reader accessibility.',
      },
    },
  },
};
...
export const InteractiveValidation: Story = {
      ...
      <form onSubmit={handleSubmit} style={{ maxWidth: '500px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <Checkbox
            ...
            errorMessage={termsError ? 'You must accept the terms to create an account' : undefined}
          ...
          <Checkbox
            ...
            errorMessage={privacyError ? 'Privacy policy acceptance is required' : undefined}
          >
            I have read and accept the Privacy Policy *
          </Checkbox>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Interactive form validation example showing real-time error states, required field validation, and proper ARIA announcements. Try submitting without checking required checkboxes to see validation in action.',
      },
    },
  },
};
...
export const AccessibilityTest: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '600px' }}>
      <div>
        ...
        <div style={{ 
          ...
          <div style={{ fontSize: '12px', color: '#666', marginBottom: '8px' }}>
            Each checkbox has a minimum 44x44px touch target (shown with dashed lines)
          </div>
          <div style={{ border: '1px dashed #ff0000', display: 'inline-block' }}>
      ...
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <Checkbox 
            aria-label="Unlabeled checkbox with aria-label"
          />
          
          <div>
            <div id="external-label" style={{ marginBottom: '8px', fontWeight: 500 }}>
      ...
      <div>
        ...
        <div style={{ 
          ...
          <div style={{ fontSize: '12px', color: '#666', marginBottom: '8px' }}>
            Use Tab to navigate, Space to toggle. Focus indicators should be clearly visible.
          </div>
          <Checkbox>First checkbox</Checkbox>
          <Checkbox>Second checkbox</Checkbox>
          <Checkbox>Third checkbox</Checkbox>
          <button style={{ marginTop: '8px', padding: '8px' }}>Focusable button after checkboxes</button>
        </div>
      </div>
    </div>
  ),
  parameters: {
    ...
    docs: {
      description: {
        story: 'Comprehensive accessibility testing examples including touch target visualization, screen reader compatibility, and keyboard navigation patterns. Use this story to verify WCAG compliance.',
      },
    },
  },
};
...
export const BrandShowcase: Story = {
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <Checkbox size="sm" isSelected>Small checkbox</Checkbox>
            <Checkbox size="md" isSelected>Medium checkbox</Checkbox>
            <Checkbox size="lg" isSelected>Large checkbox</Checkbox>
          </div>
        </div>
      </div>
    );
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Checkbox appearance across all three brand themes, showing how form controls adapt their visual styling while preserving consistent interaction patterns and accessibility features.',
      },
    },
  },
};
