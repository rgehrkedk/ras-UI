              ...
              {completionResult.success ? (
                <>
                  ...
                  <p className="text-slate-600 mb-6">
                    Your club has been successfully created and is now live on
                    our platform.
                  </p>
                  ...
                  <div className="bg-slate-50 rounded-lg p-4 mb-6 text-left">
                    ...
                    <div className="space-y-2 text-sm">
                      <p>
                        <strong>Club:</strong> {completionResult.club.name}
                      </p>
                      <p>
                        <strong>Club ID:</strong> {completionResult.club.id}
                      </p>
                      <p>
                        <strong>Subscription:</strong>{" "}
                        {completionResult.subscription.plan_type} (
                        {completionResult.subscription.billing_cycle})
                      </p>
                      <p>
                        <strong>Status:</strong>{" "}
                        {completionResult.subscription.status}
                      </p>
                    </div>
                  </div>
            ...
            {STEPS.map((step, index) => (
              <div key={step.id} className="flex items-center gap-2 flex-grow">
                ...
                {index < STEPS.length - 1 && (
                  <div
                    className={`h-0.5 flex-grow mx-2 ${step.id < currentStep ? "bg-teal-600" : "bg-slate-200"}`}
                  />
                )}
              </div>
            ))}
      ...
      {selectedPlan ? (
        <div className="bg-slate-50 rounded-xl p-6">
          <div className="flex items-center gap-4 mb-4">
            <div
              className={`w-12 h-12 bg-gradient-to-r ${selectedPlan.color} rounded-xl flex items-center justify-center text-white`}
            >
    ...
    <div className="space-y-6">
      <div>
        ...
        <Input
          ...
          onChange={(e) =>
            updateNestedFormData("location", "address", e.target.value)
          }
      ...
      <div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Input
            ...
            onChange={(e) =>
              updateNestedFormData("social_media", "facebook", e.target.value)
            }
          ...
          <Input
            ...
            onChange={(e) =>
              updateNestedFormData("social_media", "instagram", e.target.value)
            }
          ...
          <Input
            ...
            onChange={(e) =>
              updateNestedFormData("social_media", "twitter", e.target.value)
            }
      ...
      <div>
        ...
        <div className="mt-4">
          ...
          <Input
            ...
            onChange={(e) =>
              updateNestedFormData("operating_hours", "notes", e.target.value)
            }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          You can upload images through the file upload feature or use URLs from
      ...
      <div>
        ...
        />
        <p className="text-sm text-slate-500 mt-1">
          You can use Markdown formatting for rich content (headers, lists,
          links, etc.)
        </p>
      </div>
    </div>
        ...
        {price > 0 ? (
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-blue-800 text-sm">
                ...
                application, this would integrate with payment processors like
                Stripe or PayPal.
              </p>
            </div>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <p className="text-green-800">
              <strong>Great choice!</strong> Your Freemium plan is completely
              free. Click "Complete Setup" to finish creating your club profile.
            </p>
          </div>
        )}
