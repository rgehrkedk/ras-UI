    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className="text-slate-600">You are logged in, but not associated with any club.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 mb-2">Club Content Management</h1>
            <p className="text-slate-600">Update your club information and facilities</p>
          </div>
          <Button
            onClick={handleSave}
            disabled={saving}
        ...
        {saveStatus === "error" && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
            <p className="text-red-800 font-medium">Failed to save changes. Please try again.</p>
          </div>
        )}
        ...
        <div className="space-y-8">
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <Label htmlFor="image_url" className="text-base font-medium">Main Image URL</Label>
                <Input
                  id="image_url"
