...
import { Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter } from '@ras-ui/react';
    ...
    <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ 
          ...
          Showcasing Card and Badge components with sporty-book real-world patterns
        </p>
      </div>
            ...
            <CardContent>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '1rem' }}>
                {facility.sports.map(sport => (
                  <Badge key={sport} variant={BadgeUtils.getSportVariant(sport)} size="sm">
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                ...
                <Badge variant={BadgeUtils.getMembershipVariant(facility.membershipTier)}>
                  {facility.membershipTier.charAt(0).toUpperCase() + facility.membershipTier.slice(1)} Member
                </Badge>
              </div>
      ...
      <div style={{ marginTop: '3rem' }}>
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
            {['confirmed', 'pending', 'cancelled', 'active', 'inactive'].map(status => (
              <Badge key={status} variant={BadgeUtils.getStatusVariant(status)}>
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', alignItems: 'center' }}>
            ...
            <Badge variant="secondary" interactive>Clickable</Badge>
          </div>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
          <div>
            <Badge variant="success" size="sm" style={{ marginBottom: '0.5rem' }}>
          ...
          <div>
            <Badge variant="warning" size="sm" style={{ marginBottom: '0.5rem' }}>
              Zero Runtime CSS
            </Badge>
            <p style={{ margin: 0, fontSize: '0.875rem' }}>
