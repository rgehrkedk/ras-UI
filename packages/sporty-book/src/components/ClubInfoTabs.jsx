  ...
  <div className="space-y-4">
    ...
    {club.location.latitude && club.location.longitude ? (
      <div className="h-80 w-full rounded-xl overflow-hidden shadow-inner border">
        <MapContainer
          center={[club.location.latitude, club.location.longitude]}
          zoom={15}
    ...
    {club.social_media && (
      <div className="mt-6">
        ...
        <div className="flex items-center gap-4">
          {Object.entries(club.social_media).map(
            ([platform, url]) =>
              url && (
                <a
                  key={platform}
    ...
    <Card className="border-0 shadow-lg w-full min-w-0">
      <CardHeader className="p-0 border-b">
        <div className="w-full min-w-0">
          <div
            className="px-6 py-2 overflow-x-auto scrollbar-hide"
